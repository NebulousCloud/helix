...
function PANEL:Init()
    ...
    self.best:SetPos(x, h - buttonSize - scale(4))
    ...
    self.front:SetPos(x, h - buttonSize - scale(4))
    ...
    self.above:SetPos(x, h - buttonSize - scale(4))
    ...
    self.right:SetPos(x, h - buttonSize - scale(4))
    ...
    self.center:SetPos(x, h - buttonSize - scale(4))

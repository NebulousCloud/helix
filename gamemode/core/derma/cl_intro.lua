...
local PANEL = {}
	function PANEL:Init()
		...
		self.authors:AlphaTo(255, 5, 1.5, function()
			self.authors:AlphaTo(0, 5, 3, function()
				...
				self.authors:AlphaTo(255, 3, 0.5, function()
					...
					self.authors:AlphaTo(0, 3, 3, function()
						LocalPlayer():EmitSound("music/hl2_song10.mp3", 150, 80)
		...
		self.name:SetFont("nutCleanTitleFont")
		...
		self.schema:SetFont("nutBigFont")
	...
	function PANEL:addContinue()
		...
		self.info:SetFont("nutMediumFont")
	...
	function PANEL:Paint(w, h)
		...
		if (self.glow) then
			...
			surface.SetDrawColor(self.delta, self.delta, self.delta, self.delta)

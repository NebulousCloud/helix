...
nut.lang.Add("vendor_no_afford", "Vendor cannot afford to purchase this.")
nut.lang.Add("vendor_cash", "Vendor has %s.")
nut.lang.Add("classes", "Classes")
nut.lang.Add("purchased", "You have purchased a(n) %s.")
nut.lang.Add("purchased_for", "You have purchased a(n) %s for %s.")
nut.lang.Add("sold", "You have sold a(n) %s for %s.")
nut.lang.Add("attribute", "Attribute")
nut.lang.Add("attribute_tip", "This window displays your character's attribute.")
nut.lang.Add("attribute_tip2", "Your character's attribute can be increased through certain actions.")
nut.lang.Add("notenoughitem", "You don't have enough %s.")
nut.lang.Add("points_left", "You have %s point(s) left.")
nut.lang.Add("finish", "Finish")

nut.lang.Add("name", "Name")
nut.lang.Add("name_desc", "The name your character for roleplay." )
nut.lang.Add("desc", "Description")
nut.lang.Add("gender", "Gender")
nut.lang.Add("gender_desc", "Your character's gender.")
nut.lang.Add("model", "Model")
nut.lang.Add("model_desc", "How your character will appear in-game.")

nut.lang.Add("char_create_tip", "Fill in all of the following fields then press 'Finish'.")
nut.lang.Add("char_create_warn", "Your character information must be appropriate." )

--[[
	Purpose: Sets up a translations that are to be used in the script. Useful for communities that do not use English as their primary language.
...
nut.lang.Add("schema_author", "CrÃ©e par %s.", language)
nut.lang.Add("create", "CrÃ©er", language)
nut.lang.Add("create_tip", "CrÃ©er un nouveau personnage.", language)
nut.lang.Add("load", "Charger", language)
nut.lang.Add("load_tip", "Charger le personnage prÃ©cÃ©dent.", language)
...
nut.lang.Add("delete_question", "ÃŠtes vous sÃ»r de vouloir effacer %s?", language)
...
nut.lang.Add("desc_status", "Je suis dÃ©crit comme ", language)
nut.lang.Add("desc_char_req", "Votre description doit avoir au moins %s caractÃ¨re(s).", language)
nut.lang.Add("char_validating", "Veuillez patienter, le serveur charge les donnÃ©es.", language)
...
nut.lang.Add("dead_talk_error", "Vous ne pouvez pas parler quand vous Ãªtes mort.", language)
...
nut.lang.Add("missing_arg", "Vous avez oubliÃ© de mettre une valeure Ã  la commande.", language)
nut.lang.Add("already_whitelisted", "Ce personnage est dÃ©jÃ  dans la whitelist.", language)
...
nut.lang.Add("flags_give", "%s a donnÃ© les flags '%s' Ã  %s.", language)
nut.lang.Add("flags_take", "%s a prit les flags '%s'Ã  %s.", language)
nut.lang.Add("no_invspace", "Cet objet est trop lourd pour votre inventaire.", language)
nut.lang.Add("settings", "ParamÃ¨tres", language)
...
nut.lang.Add("classes", "Classes", language)
nut.lang.Add("purchased", "Vous avez achetÃ© un(e) %s.", language)
nut.lang.Add("purchased_for", "Vous avez achetÃ© un(e) %s pour %s.", language)
...
nut.lang.Add("attribute_tip2", "Les attributs de votre personnage peuvent Ã©voluer en faisant certaines choses.", language)
...
nut.lang.Add("model", "ModÃ¨le", language)
...
nut.lang.Add("char_create_warn", "Les informations de votre personnage doivent Ãªtre appropriÃ©.", language)

...
nut.lang.Add("business", "Achat", language)
nut.lang.Add("no_afford", "Vous ne pouvez pas se permettre d'acheter ce.", language)
...
nut.lang.Add("classes", "Des classes", language)
...
nut.lang.Add("attribute_tip", "Ce menu affiche l'attributs de votre personnage.", language)
nut.lang.Add("attribute_tip2", "L'attributs de votre personnage peut être accrue par certains actes", language)
nut.lang.Add("notenoughitem", "Vous n'avez pas assez %s.", language)
nut.lang.Add("points_left", "Vous avez %s point(s) restant.", language)
nut.lang.Add("finish", "Finir", language)

nut.lang.Add("name", "Nom", language)
nut.lang.Add("name_desc", "Le nom de votre personnage.." )
nut.lang.Add("desc", "Description", language)
nut.lang.Add("gender", "Sexe", language)
nut.lang.Add("gender_desc", "Le sexe de votre personnage.", language)
nut.lang.Add("model", "Model", language)
nut.lang.Add("model_desc", "Qu'est-ce que votre personnage ressemble.", language)

nut.lang.Add("char_create_tip", "Fill in all of the following fields then press 'Finish'.", language)
nut.lang.Add("char_create_warn", "Les informations de votre personnage doit être approprié" )
nut.lang.Add("inv_tip", "Vous pouvez utiliser vos objets de votre inventaire en faisant un clic gauche dessus.", language)
nut.lang.Add("business_tip", "Cliquez sur l'objet pour acheter", language)
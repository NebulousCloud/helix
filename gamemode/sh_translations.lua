...
nut.lang.Add("attribute_tip2", "Your character's attribute can be increased by certain action.")
...
nut.lang.Add("name_desc", "The name what you're going to use in the RP." )
nut.lang.Add("desc", "Description")
nut.lang.Add("gender", "Gender")
nut.lang.Add("gender_desc", "The Gender of your character")
nut.lang.Add("model", "Model")
nut.lang.Add("model_desc", "The General look of your character.")

nut.lang.Add("char_create_tip", "Please fill all the fields then press the 'Finish' button below.")
nut.lang.Add("char_create_warn", "Joke/Absurd character is not allowed." )

...
nut.lang.Add("load_tip", "Charger le personnage pr��c��dent.", language)
...
nut.lang.Add("delete_question", "��tes vous s��r de vouloir effacer %s?", language)
...
nut.lang.Add("dead_talk_error", "Vous ne pouvez pas parler quand vous ��tes mort.", language)
...
nut.lang.Add("settings", "Param��tres", language)
...
nut.lang.Add("attribute_tip2", "Les attributs de votre personnage peuvent ��voluer en faisant certaines choses.", language)
...
nut.lang.Add("model", "Mod��le", language)
...
nut.lang.Add("char_create_warn", "Les informations de votre personnage doivent ��tre appropri��.", language)

...
LANGUAGE = {
	...
	attributeSet = "Vous avez mis à %s de %s à %s.",
	attributeUpdate = "Vous avez ajouté à %s de %s, %s pour être précis.",
	...
	containerPassword = "Le mot de passe de ce stockage est %s.",
	containerPasswordRemove = "Vous avez supprimé le mot de passe de ce stockage.",
	containerPasswordWrite = "Entrez le mot de passe.",

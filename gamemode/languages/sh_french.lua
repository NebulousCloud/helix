...
LANGUAGE = {
	...
	display = "Afficher",
	loading = "Chargement",
	dbError = "La connexion à la base de données a échoué",
	unknown = "Inconnu",
	...
	misc = "Divers",
	oocDelay = "Vous devez attendre %s secondes avant de réutiliser le OOC !",
	loocDelay = "Vous devez attendre %s secondes avant de réutiliser le LOOC !",
	...
	drop = "Jeter",
	dropTip = "Jete cet objet de votre inventaire.",
	take = "Prendre",
	...
	dSetHidden = "Tu as caché cette porte.",
	dSetNotHidden = "Tu as montré cette porte.",
	...
	sell = "Vendre",
	access = "Accès",
	locking = "Verrouiller cette entité...",
	unlocking = "Déverrouiller cette entité...",

...
LANGUAGE = {
	...
	attributeSet = "Вы поменяли %s's %s на %s.",
	attributeUpdate = "Вы добавили %s's %s by %s.",
	...
	containerPassword = "Вы установили пароль контейнера на %s.",
	containerPasswordRemove = "Вы убрали пароль контейнера.",
	...
	contentWarning = "У вас не установлен контент Helix. Некоторые функции могут не работать.\nВы желаете перейти на страницу скачивания контента?",
	Assign = "Присвоить",
	Freq = "Частота",
	Toggle = "Переключить",
	Use = "Использовать",

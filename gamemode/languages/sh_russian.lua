...
LANGUAGE = {
	...
	flagSpawnChairs = "Доступ к спавну стульев.",
	flagSpawnVehicles = "Доступ к спавну транспорта.",
	flagSpawnRagdolls = "Доступ к спавну рэгдоллов.",
	...
	optAltLower = "Скрывать опущенное оружие",
	optdAltLower = "Скрывать активное оружие, руки и прочее, если оно опущено.",

...
LANGUAGE = {
	...
	loadTitle = "Выбрать и загрузить персонажа.",
	...
	dSetHidden = "Вы скрыли данную дверь.",
	dSetNotHidden = "Вы сделали эту дверь не скрытой.",
	...
	canNotAfford = "Вы не можете приобрести эту дверь!",
	...
	wakingUp = "Вы возвращаетесь в сознание...",
	Weapons = "Оружие",
	...
	injMajor = "Выглядит очень плохо",
	injLittle = "Выглядит слегка поврежденным",
	chgName = "Сменить имя",
	...
	optAlwaysShowBars = "Постоянный HUD",
	...
	optdThirdpersonVertical = "Высота расположения карты от 3 лица.",
	...
	cmdFixPAC = "Попытаться исправить ошибки от PAC3.",

...
LANGUAGE = {
	...
	flagPhysgun = "Access to the physgun.",
	flagToolgun = "Access to the toolgun.",
	flagSpawnChairs = "Access to spawn chairs.",
	flagSpawnVehicles = "Access to spawn vehicles.",
	flagSpawnRagdolls = "Access to spawn ragdolls.",
	flagSpawnProps = "Access to spawn props.",
	flagSpawnNPCs = "Access to spawn NPCs.",
